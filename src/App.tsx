  ...
  export default function App() {
    ...
    useEffect(() => {
      ...
      // If we have OAuth callback params, navigate to callback page
      if (code && state) {
    ...
    // Don't show navbar during OAuth callback
    ...
    return (
      <div className="min-h-screen bg-neutral-950 text-white selection:bg-[#00AAFF]/30 selection:text-white">
        ...
        {/* Auth indicator */}
        {isAuthenticated && user && activePage !== 'editor' && activePage !== 'oauth-callback' && (
